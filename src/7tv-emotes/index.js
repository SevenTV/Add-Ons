class SevenTVEmotes extends Addon {
	...
	async onEnable() {
		...
		this.chat.context.on('changed:addon.seventv_emotes.animated_avatars', () => this.updateAnimatedAvatars());
	...
	async updateAnimatedAvatars() {
		...
		if (!this.chat.context.get('addon.seventv_emotes.animated_avatars')) return;
